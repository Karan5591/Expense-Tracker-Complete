...
exports.loginData= (req, res)=>{
    res.sendFile('/Expense-Tracker-Complete/Expense Details added/public/SignIn.html');
}

exports.signUp= (req, res)=>{
    res.sendFile('/Expense-Tracker-Complete/Expense Details added/public/register.html');
}
